...
export function Hero() {
  return (
    <section className="relative isolate flex min-h-[100svh] items-center overflow-hidden pt-28 sm:pt-32">
        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1.15fr_1fr]">
          <div className="space-y-8">
            <Badge variant="default" className="animate-fade-in">
              ...
              Сезон 2026 · Открыт набор
            </Badge>

            <h1 className="animate-fade-up font-display text-5xl font-bold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">
              <span className="text-foreground">Притяжение силы.</span>
              <br />
              <span className="text-gradient">Орбита команды.</span>
            </h1>

            <p className="max-w-xl animate-fade-up text-lg leading-relaxed text-muted-foreground [animation-delay:120ms]">
              Galaxy Volleyball Club — премиальный волейбольный клуб нового
              поколения. Технологичные тренировки, аналитика выступлений и
              атмосфера большого спорта в каждом матче.
            </p>
            ...
            <dl className="grid max-w-md animate-fade-up grid-cols-3 gap-6 pt-6 [animation-delay:360ms]">
              {[
                { value: "12", label: "лет в спорте" },
                { value: "8", label: "команд" },
                { value: "320+", label: "воспитанников" },
              ].map((stat) => (
          ...
          {/* Декоративная орбита-визуализация */}
      ...
      {/* Нижняя дымка для гладкого перехода */}
      <div
        aria-hidden
